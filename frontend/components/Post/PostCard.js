...
// Adds a working "View comments" modal wired to CommentSection.
    ...
    <article className="bg-zinc-900 border border-zinc-800 rounded-xl overflow-hidden mb-4 max-w-[600px] mx-auto w-full">
      ...
      <div className="px-4 py-3">
        ...
        {commentsCount > 0 && (
          <button
            onClick={() => setShowComments(true)}
            className="text-sm text-zinc-400 mt-2 hover:text-zinc-300"
          >
      ...
      {showComments && (
        ...
        >
          <div
            className="bg-zinc-900 w-full sm:max-w-md sm:rounded-xl h-[70vh] sm:h-[500px] flex flex-col"
          ...
          >
            ...
            <div className="flex-1 overflow-hidden p-3">
              <CommentSection
                postId={post._id}
                onCommentsCountChange={(c) => c != null && setCommentsCount(c)}
              />
            </div>
          </div>
        </div>
